...
export const fetchDataPost = createAsyncThunk("post/fetchDataPost", async () => {
    const res = await http.get('/wp/v2/posts?_embed')
    return res.data
})

export const fetchDataCategory = createAsyncThunk("post/fetchDataCategory", async () => {
