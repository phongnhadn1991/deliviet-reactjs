...
import { fetchDataCategory, selectListCate } from '../../../features/post/postSlice';
                ...
                <div className="bg-white shadow-md">
                  <table className="min-w-max w-full table-auto">
                    ...
                    <tbody className="text-gray-600 text-sm font-light">
                      {!isLoadingSkeleton && listCategory && listCategory.length > 0 && listCategory.map(item => (
